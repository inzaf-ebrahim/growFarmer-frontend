  ...
  return (
    <div>
      ...
      >
        ...
        <button className="text-white rounded-md bg-green-500 hover:bg-green-900 hover:scale-90 px-3 p-2 ml-6 mt-3">
          <Link to="/signup">Get Started</Link>
        </button>
        <h1 className="text-white text-center pt-5 text-xl font-bold">
          {" "}
          Discover more
        </h1>
